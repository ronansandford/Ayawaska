...
package as3.ayawaska.test 
{
	...
	import as3.ayawaska.engine.world.twodimensions.Sample2DEntity;
	
	public class TestEntity extends Sample2DEntity 
	{
		
		public function TestEntity(type : EntityType) 
		{
			super(type);
		}
		
		public function goKill(entity : Entity) : void
		{
